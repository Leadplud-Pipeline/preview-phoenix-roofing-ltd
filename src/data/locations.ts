...
export const locations: LocationData[] = [
  {
    slug: "bristol",
    name: "Bristol",
    heroDesc: "Bristol is our home base. Phoenix Roofing Ltd provides trusted roofers services to homes and businesses across Bristol and the surrounding areas.",
    whyChoose: [
    ...
    metaTitle: "Roofers in Bristol | Phoenix Roofing Ltd",
    metaDesc: "Looking for trusted roofers in Bristol? Phoenix Roofing Ltd offers free quotes, quality workmanship, and fully insured services."
  }
];
