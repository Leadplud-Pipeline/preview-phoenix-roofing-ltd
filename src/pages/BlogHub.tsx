...
const BlogHub = () => (
  <Layout>
    <SEO title="Roofing Advice & Guides | Phoenix Roofing Ltd" description="Expert roofing tips from Phoenix Roofing Ltd. Knowledge freely shared. Guides for homeowners in the Bristol & Bristol." />
    <section className="section-dark section-padding">
      <div className="container-content">
        <Breadcrumbs items={[{ name: "Home", href: "/" }, { name: "Blog" }]} />
        <h1 className="text-3xl md:text-5xl text-secondary-foreground mb-4">Roofing Advice & Guides</h1>
        <div className="heading-rule" />
        <p className="text-secondary-foreground/80 font-sans text-lg max-w-2xl leading-relaxed">Expert tips from Phoenix Roofing Ltd. Knowledge freely shared.</p>
      </div>
    </section>
