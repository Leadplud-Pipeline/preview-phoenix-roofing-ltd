    ...
    <Layout>
      ...
      <section className="section-dark section-padding">
        <div className="container-content">
          ...
          <p className="text-sm font-sans text-secondary-foreground/60 mb-2">{new Date(post.date).toLocaleDateString("en-GB", { day: "numeric", month: "long", year: "numeric" })} · Phoenix Roofing Ltd</p>
      ...
      <section className="section-dark section-padding">
        <div className="container-content max-w-3xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="tel:+447361066363" className="border border-secondary-foreground/30 text-secondary-foreground px-8 py-3 rounded font-sans font-semibold hover:bg-secondary-foreground/10 transition-colors">Call +44 7361 066363</a>
          </div>
        </div>
      </section>
      {/* BlogPosting JSON-LD */}
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        publisher: { "@type": "Organization", name: "Phoenix Roofing Ltd" },
