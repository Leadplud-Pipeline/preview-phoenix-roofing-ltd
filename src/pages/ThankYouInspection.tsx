...
const ThankYouInspection = () => {
  ...
  useEffect(() => {
    ...
    document.title = "Appointment Booked | Phoenix Roofing Ltd";
  }, []);
    ...
    <div className="min-h-screen bg-secondary flex flex-col">
      ...
      <header className="w-full bg-secondary border-b border-white/10">
        <div className="flex items-center justify-center py-4 px-4">
          <img src={logo} alt="Phoenix Roofing Ltd logo" width={220} height={88} className="h-14 w-auto object-contain" />
        </div>
      </header>
