  ...
  return (
    <Layout>
      ...
      <section className="section-surface section-padding">
        <div className="container-content max-w-3xl">
          <h2 className="text-xl md:text-2xl mb-4">Why Choose Phoenix Roofing Ltd</h2>
          <div className="heading-rule" />
          <ul className="space-y-3">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        provider: { "@type": "HomeAndConstructionBusiness", name: "Phoenix Roofing Ltd", telephone: "+447361066363", address: { "@type": "PostalAddress", streetAddress: "Bristol", addressLocality: "Bristol", postalCode: "FY4 4EF", addressRegion: "Bristol", addressCountry: "GB" } },
