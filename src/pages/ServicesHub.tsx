...
const ServicesHub = () => (
  <Layout>
    <SEO title="Our Roofing Services | Phoenix Roofing Ltd" description="Complete roofing services across the Bristol & Bristol: emergency repairs, replacements, flat roofing, guttering, and more. Free roof inspections." />
