...
const LocationsHub = () => (
  <Layout>
    <SEO title="Phoenix Roofing Ltd: Serving Cumbria & Bristol" description="We cover the Bristol, Ormskirk, and surrounding areas within a 30-mile radius. Expert roofing services across the North West." />
    <section className="section-dark section-padding">
      <div className="container-content">
        <Breadcrumbs items={[{ name: "Home", href: "/" }, { name: "Locations" }]} />
        <h1 className="text-3xl md:text-5xl text-secondary-foreground mb-4">Phoenix Roofing Ltd: Serving Cumbria & Bristol</h1>
